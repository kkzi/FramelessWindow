...
#  include "contexts/win32windowcontext_p.h"
#elif defined(Q_OS_MAC) && !QWINDOWKIT_CONFIG(ENABLE_QT_WINDOW_CONTEXT)
#  include "contexts/cocoawindowcontext_p.h"
#else
#  include "contexts/qtwindowcontext_p.h"
#endif
...
namespace QWK {
    ...
    */
    ...
    static WindowContextFactoryMethod windowContextFactoryMethod = nullptr;
