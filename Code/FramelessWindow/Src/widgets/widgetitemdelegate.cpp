...
#include "../core/contexts/abstractwindowcontext_p.h"
...
namespace QWK
{
    ...
    public:
        explicit WidgetWinIdChangeEventFilter(QObject *host, AbstractWindowContext *ctx)
            ...
            , widget(static_cast<QWidget *>(host))
        {
    ...
    void WidgetItemDelegate::resetQtGrabbedControl(QObject *host) const
    {
        ...
        const auto event = new QMouseEvent(QEvent::MouseButtonRelease, invalidPos, invalidPos, invalidPos, Qt::LeftButton,
    ...
    WinIdChangeEventFilter *WidgetItemDelegate::createWinIdEventFilter(QObject *host, AbstractWindowContext *context) const
    {
